...
> `mac-v0.3.93-author.1` and the current `mac-author-build` head resolve to
...
> documentation and tag-pinned release tooling. PR
> [#80](https://github.com/Azure/ConfigForge/pull/80) merges the tagged
> release branch to `mac-author-build`.
...
tag-pinned macOS workflow also passed the install, production audit, build,
...
documentation/tooling in PRs #79 and #80: @ABMFST and Copilot.
