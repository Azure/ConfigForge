        ...
        <div className="overflow-x-auto">
          <table className="w-full table-fixed text-sm">
            ...
            <tbody className="divide-y divide-slate-200 dark:divide-slate-800">
              ...
              {(complianceShowAll ? resources : resources.slice(0, INITIAL_TABLE_ROWS)).map(
                (resource, idx) => {
          ...
          {!complianceShowAll && resources.length > INITIAL_TABLE_ROWS && (
            <div className="border-t border-slate-200 dark:border-slate-800 px-6 py-3">
              ...
              >
                {t("tables.showAllResources", { count: resources.length })}
