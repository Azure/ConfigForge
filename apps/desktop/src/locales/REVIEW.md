...
Layout warnings (>150% of English): **73**
...
| history | restore.warning | 188 | 149 | 126% | Le baseline actuel sera instantané automatiquement avant la restauration, donc vous pourrez revenir en arrière. Le réenregistrement peut redéployer l’état souhaité sur les appareil |
...
| diff | errors.loadManifestsTimeout | 183 | 129 | 142% | Das Laden baselines zeitlich abgelaufen. Der Hintergrundlistenaufruf dauert länger als 10 Sekunden – versuche es mit Aktualisieren oder starte die App neu, falls es weiterhin beste |
...
| home | interrupted.description | 183 | 141 | 130% | Tu dispositivo puede estar en una state{{startedAt}} parcialmente aplicada. Realiza una auditoría para comprobar el cumplimiento actual o vuelve a la instantánea previa al desplieg |
