...
| settings | about.authorFlavor | 202 | 150 | 135% | Sabor de compilación: autor. Solo edición de manifiestos, biblioteca, comparación de cumplimiento y PDF de paquete de auditoría. Use la compilación de Windows o Linux para implemen |
