...
export const BASELINE_CATALOG: BaselineEntry[] = [
  ...
  // ── Windows Server 2022 ──────────────────────────────────────────────
  {
    ...
    description:
      'Azure security baseline for Windows Server 2022 member servers. 257 settings covering registry, CSP, account policy, audit policy, and user rights.',
    platform: 'windows',
    category: 'security-baseline',
    version: '2510',
    source: 'local',
    ...
    githubUrl:
      'https://github.com/microsoft/osconfig/blob/main/manifests/azure-security-baseline-windows-server-2022-domain-member.yaml',
    resourceCount: 257,
    resourceTypes: ['Microsoft.OSConfig/Test'],
  ...
  },
  {
    ...
    githubUrl:
      'https://github.com/microsoft/osconfig/blob/main/manifests/azure-security-baseline-windows-server-2022-domain-controller.yaml',
    resourceCount: 242,
    resourceTypes: ['Microsoft.OSConfig/Test'],
  ...
  },
  {
    ...
    githubUrl:
      'https://github.com/microsoft/osconfig/blob/main/manifests/azure-security-baseline-windows-server-2022-workgroup-member.yaml',
    resourceCount: 200,
    resourceTypes: ['Microsoft.OSConfig/Test'],
