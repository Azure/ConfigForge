...
.PARAMETER Tag
    The release tag, e.g. "mac-v0.3.93-author.2". Must already exist as a
...
.EXAMPLE
    .\scripts\ship-mac.ps1 -Tag mac-v0.3.93-author.2

.EXAMPLE
    .\scripts\ship-mac.ps1 -Tag mac-v0.3.93-author.2 -NotesFile .\apps\desktop\build\release-notes-author.md
#>
