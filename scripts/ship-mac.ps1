...
.PARAMETER Tag
    The release tag, e.g. "mac-v0.3.95-author.1". Must already exist as a
...
.EXAMPLE
    .\scripts\ship-mac.ps1 -Tag mac-v0.3.95-author.1

.EXAMPLE
    .\scripts\ship-mac.ps1 -Tag mac-v0.3.95-author.1 -NotesFile .\apps\desktop\build\release-notes-author.md
#>
