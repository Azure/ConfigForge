...
| --- | --- | --- |
| Full edition for Windows and Linux | `v0.3.97` | Supported tagged source; release remains a draft |
| macOS Author edition | `mac-v0.3.97-author.1` | Supported tagged source; release remains a draft |
