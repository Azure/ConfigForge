...
| Version | Highlights |
|---|---|
| **0.3.75** (current) | Predictable namespace/display-name search in My Baselines; responsive Visual tables with no horizontal-scroll overlap; spreadsheet editing shared by Baseline Detail and Register New Baseline; anchored Edit/Save footer; full FR/DE/ES coverage |
