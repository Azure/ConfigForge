...
| Version | Highlights |
|---|---|
| **0.3.76** (current) | Cognitive Walkthrough polish: Pairwise Diff for two selections, shared Code/Visual Undo and read-only guidance, discoverable device compliance, corrected platform/status presentation, and streamlined onboarding/Benchmark Mapping |
