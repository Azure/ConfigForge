...
| Version | Highlights |
|---|---|
| **0.3.76-author.1** (current) | macOS author flavor with author-only Recent Activity for registration/edit history, predictable namespace/display-name search in My Baselines, responsive Visual tables, spreadsheet editing shared by Baseline Detail and Register New Baseline, and full FR/DE/ES coverage |
