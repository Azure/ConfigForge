...
| Version | Highlights |
|---|---|
| **0.3.84** (current) | Clears all remaining high-severity development dependency advisories with `concurrently` 9.2.4, `shell-quote` 1.9.0, and patched `brace-expansion` releases |
