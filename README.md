...
| Version | Highlights |
|---|---|
| **0.3.84-author.1** (current) | macOS author flavor with all high-severity development dependency advisories cleared across `tar`, `axios`, `shell-quote`, and `brace-expansion` |
