...
| Version | Highlights |
|---|---|
| **0.3.81-author.1** (current) | macOS author flavor with first-class OSConfig CSV imports, fully labeled responsive Baseline Detail actions, author-only Recent Activity, spreadsheet editing, and full FR/DE/ES coverage |
