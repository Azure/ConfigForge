...
A concise release history for ConfigForge. Newer entries use their release
...
- PR [#80](https://github.com/Azure/ConfigForge/pull/80) merged at `099be06`,
  and annotated tag `mac-v0.3.93-author.1` targets that merge. Tag-pinned
  workflow run
