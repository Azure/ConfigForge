...
- [Install & run](./quick-start/install-run.md)
- [Your first manifest](./quick-start/first-manifest.md)
...
- [Registration semantics](./architecture/registration-semantics.md)
- [Mixed-platform classification](./architecture/mixed-platform.md)
...
- [CI on Linux + Windows](./operations/ci.md)
- [Smoke testing on Windows](./operations/smoke-testing.md)
- [Filing upstream bugs](./operations/upstream-bugs.md)
- [Troubleshooting](./operations/troubleshooting.md)

# Contributing

- [`AGENTS.md` (canonical guide)](./contributing/agents-md.md)
- [Coding conventions](./contributing/conventions.md)
- [Testing expectations](./contributing/testing.md)
- [Adding a new oscfg type](./contributing/adding-oscfg-types.md)

# Reference

- [Manifest schema (oscfg 1.3.9-preview11)](./reference/manifest-schema.md)
- [Registered types](./reference/registered-types.md)
