...
manifest metadata and can include compliance, history, rationale, and
citations when those inputs are available. The Full edition can also include
device-audit inputs; the macOS Author edition does not expose device-audit
storage. Open
